    ...
    return (
        <div className='flex flex-col gap-3 border-0 rounded-3xl w-96 items-center h-[812px] bg-nig-80 overflow-hidden'>
            ...
            <div className="w-80 flex flex-col gap-3 font-semibold text-md">
                <div className="bg-nig-100 h-[50px] rounded-2xl flex items-center px-3 justify-between">
                    ...
                    <p className="text-sm px-6 text-nig-30 font-semibold">Upcoming bills</p>
                </div>
            ...
            <div className="w-80 h-[64px] flex">
                ...
                <button className='bg-peach-0 rounded-full px-3 py-3 h-12 mx-2 border-[1px] border-b-0 border-nig-0/50 text-nig-0 drop-shadow-text-shadow hover:bg-peach-50 transition-colors duration-300 ease-in-out hover:cursor-pointer'>
