...
export default function PageHeading({title = '', className}) {
    ...
    return (
        <>
            <div className={`${className} flex w-full justify-end pr-6 mt-6 z-30`}>
                <div className='' onClick={() => navigate('/app/settings')}>
            ...
            <p className='absolute mt-[28px] font-light text-lg text-nig-30'>{title}</p>
        </>
    )
}