...
export default function NewSubscription() {
    ...
    return (
        <div className='flex flex-col gap-3 border-0 w-full items-center h-screen bg-nig-80 overflow-hidden'>
            ...
            <form onSubmit={handleSubmitNewSub} className="w-full flex flex-col text-center h-full gap-2 font-semibold text-md px-6 py-3 justify-start overflow-y-scroll border-0 border-white ">
                ...
                <div className="text-nig-50">
                    <label htmlFor="payday" className="text-sm -mb-[20px]">Pay Day</label>
                ...
                <div className='flex w-full justify-between items-center py-3'>
                    ...
                    <div className='text-xs font-semibold text-nig-40'>
                        <div className='flex flex-col items-center gap-1'>
                            <p className='text-sm text-nig-50'>Monthly Price</p>
                ...
                <div className='w-full h-full flex flex-col justify-end items-center py-6'>
                    <Button text='Add this platform' width={300} />
